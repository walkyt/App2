...
public class LoginRegister extends AppCompatActivity {
    ...
    public void registerUser(View view){
        ...
        if(TextUtils.isEmpty(email) || TextUtils.isEmpty(password)){
            Toast.makeText(LoginRegister.this,"Please fill in your email address or password", Toast.LENGTH_SHORT).show();
        }
        else{
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>(){
                public void onComplete(@NonNull Task<AuthResult> task){
                    if(task.isSuccessful()){
                        ...
                        Intent userIntent = new Intent(LoginRegister.this, DrunkTesting.class);
                        startActivity(userIntent);

                        Toast.makeText(LoginRegister.this," User Register Successfully", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                    else{
                        Toast.makeText(LoginRegister.this, "User Register Unsuccessful.Please try again.", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
    ...
    public void loginUser(View view){
        ...
        if(TextUtils.isEmpty(email) || TextUtils.isEmpty(password)){
            ...
            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>(){
                public void onComplete(@NonNull Task<AuthResult> task){
                    if(task.isSuccessful()){
                        Intent loginSuccessful = new Intent (LoginRegister.this, DrunkTesting.class);
                        startActivity(loginSuccessful);
                        Toast.makeText(LoginRegister.this," User Login Successfully", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                    else{
                        Toast.makeText(LoginRegister.this, "User Login Unsuccessful.Please try again.", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
